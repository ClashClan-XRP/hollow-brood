...
export type Job = "none" | "harvest" | "forage" | "scavenge" | "build" | "guard" | "rove" | "follow" | "hibernate" | "haul" | "hold";
export type Evo =
  | "biter"
  | "melee"
  | "tank"
...
export const DIFFICULTIES: Record<Difficulty, DifficultyTune> = {
  ...
  standard: {
    id: "standard",
    label: "Standard",
    blurb: "A grove and scrap bed in the silk. Towers first, then march.",
    food: 40,
    material: 20,
    foodCap: 72,
    matCap: 36,
